...
Studierende neigen dazu noch keine allzu verfeinerten Kochkünste aufzuweisen (dabei bestätigen Ausnahmen selbstverständlich die Regel). Jedenfalls sind so manche frisch von Zuhause ausgezogene Studierende auf eine Ernährung abseits von Tiefkühl-Pizza und Mensaessen angewiesen.\\
