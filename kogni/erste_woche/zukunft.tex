...
\\
Die meisten Veranstaltungen in unserem Studium sind fest vorgegeben. Erst in den späteren Semestern haben wir fünf Wahlpflichtmodule: Philosophie, Linguistik, Kognitionsinformatik, Kognitionswissenschaftliche Forschungsthemen und Vertiefung Kognitionswissenschaft. In diesen Modulen könnt ihr aus den im ALMA\footnote{\url{https://alma.uni-tuebingen.de}} unter dem jeweiligen Modul aufgeführten Veranstaltungen frei wählen. Die Module, die ohne Mehraufwand anrechenbar sind, sind im Reiter Mein Studium -> Studienplaner mit Modulplan zu finden.\\
Außerdem habt ihr noch Wahlmöglichkeiten in den Modulen Experimentelle Kognitionswissenschaft und dem Teamprojekt. In experimenteller Kognitionswissenschaft wendet ihr die, in den ersten Semestern erworbenen, Grundlagen der empirischen Forschung kombiniert mit eurem dazu gewonnenen Wissen zum ersten Mal an und führt in Kleingruppen jeweils ein Experiment durch. Wem das Spaß macht kann im Teamprojekt wieder empirisch arbeiten und ein Psychologieprojekt wählen. Wer es lieber technischer mag, kann stattdessen auch ein eher Informatiknahes Programmierprojekt wählen.
