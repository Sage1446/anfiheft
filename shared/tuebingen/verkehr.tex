...
Semesters \semesterticketpreis \ (der Rest ist im Solidarbeitrag, der Teil des Semesterbeitrags ist, enthalten).
...
Eine Alternative ist das \emph{Deutschlandticket JugendBW} für \jugendticketbwpreis \ pro Monat,
das in ganz Deutschland gilt (nicht im Fernverkehr, also ICE, IC, EC und Fernbus).
Im Gegensatz zum Semesterticket gibt es beim JugendBW-Ticket eine Altersbeschränkung,
es kann nur von Studierenden gekauft werden, die zu Beginn des Semesters noch 26 Jahre alt oder jünger sind.

Eine weitere Alternative bietet das Deutschland-Ticket, das \dticketpreis \ pro Monat kostet und ebenfalls für den Regionalverkehr in ganz Deutschland gilt. Anders als das JugendBW-Ticket hat es keine Altersbeschränkung, ist dafür aber teurer. Tübinger Einwohner*innen
(d.h. wenn auf dem Personalausweis Tübingen als Wohnort eingetragen ist) können das Deutschland-Ticket für \dtickettuebingenpreis \ pro Monat erwerben.
...
Wer trotz dieses guten Angebots an Nahverkehrsmittel mit dem Auto kommen will/muss, sollte beachten, dass es weder auf dem Sand, noch auf der Morgenstelle kostenlose Parkplätze gibt. Mehr Informationen zu Parkgebühren und Dauerparken findet ihr hier:

\link{https://uni-tuebingen.de/de/281955}{Parkplätze der Uni}

% %%%%%%%% afaik ist folgendes nicht mehr aktuell %%%%%%%%
% Auf der Morgenstelle benötigt man für den studentischen Parkplatz eine Nutzungsberechtigung, die man aber nur erhält, wenn die Fahrzeit mit Bus und Bahn länger als 40 Minuten dauern würde, außerdem ist die Anzahl an Parkplätzen sehr begrenzt.
% Erledigen könnt ihr die Freischaltung in dem Büro schräg gegenüber dem Studierendenterminal im Hörsaalzentrum (direkt neben dem Ausgang Richtung Neubau Chemie). Ihr müsst dafür aber unbedingt das Datenkontrollblatt mitbringen, welches euch per Post zugeschickt wurde. Für alle anderen mit kürzerer Fahrzeit steht oberhalb der Morgenstelle ein kostenpflichtiges Parkhaus zur Verfügung. Wenn ihr eine Parkkarte für das ganze Semester kauft, wird's deutlich günstiger. Infos zu den Tarifen des Parkhauses findet ihr unter:
