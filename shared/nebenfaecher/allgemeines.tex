...
\textbf{Achtung: Die nachfolgenden Artikel ersetzen nicht die
  ...
  der Studierenden geben;  Die Auswahl erfolgte willkürlich, d. h. es sind
  nur die Schwerpunktmodule beschrieben, zu denen Informationen von
  Studierenden zu erhalten waren (zur Zeit können wir bei den meisten Schwerpunktmodulen keine Angaben zu den zu besuchenden Veranstaltungen machen, wir haben euch aber zu jedem der Schwerpunktmodul den zuständigen Prof. angegeben). Habt ihr euch für ein Schwerpunktmodul
